...
if __name__ == "__main__":
    main(), r'<h1>\1</h1>', text, flags=re.MULTILINE)
    text = re.sub(r'^## (.*?)
...
if __name__ == "__main__":
    main(), r'<h2>\1</h2>', text, flags=re.MULTILINE)
    text = re.sub(r'^### (.*?)
...
if __name__ == "__main__":
    main(), r'<h3>\1</h3>', text, flags=re.MULTILINE)
...
if __name__ == "__main__":
    main(), r'<li>\1</li>', text, flags=re.MULTILINE)
